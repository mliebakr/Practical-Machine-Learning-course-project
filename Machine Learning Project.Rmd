...
```{r, echo=FALSE}
set.seed(55677)
modfit1 <- train(classe~., data=mtrain, method="gbm", verbose=FALSE)  ## accuracy/kappa 0.8122661  0.7618243
modfit2 <- train(classe~., data=mtrain, method="rf")   ## accuracy/kappa 0.9324219  0.9144129
library(e1071)
...
confusionMatrix(pred1,mtest$classe) #0.8199 
confusionMatrix(pred2,mtest$classe) #0.9441 
confusionMatrix(pred3,mtest$classe) # 0.7884 
